class Pause extends Phaser.Scene {
    ...
    create(){
        ...
        // buttons
        this.playButton = this.add.image(game.canvas.width/2, game.canvas.height/2, 'playButton').setScale(1.5);
        this.playButton.setInteractive();
        this.menuButton = this.add.image(game.canvas.width/2, game.canvas.height/2+this.playButton.width, 'menuButton').setScale(1.5);
